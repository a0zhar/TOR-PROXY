...
app.popup.receive("popup-data", function (e) {
  switch (e.name) {
    case "reload":  app.tab.reload(); break;
    case "ip":      app.tab.open(config.url.ip); break;
    case "check":   app.tab.open(config.url.tor); break;
    case "support": app.tab.open(app.homepage()); break;
    case "install": app.tab.open(config.url.github); break;
    case "bypassList":
